...
#### Added
   ...
   - [x] inPairSelection: command to select inside a pair of separators: '(',')'; '[',']'; '{','}';'<','>'; '>', '<'; or any char pair: '''; '"'...<a href="https://github.com/metaseed/metaGo#inside-pairs-selection">(Detail)</a>
#### Removed
#### Changed
