...
(h: left)
(H: history of current tab(omnibar))
(i: reserved, insert, to type in input/edit box)
(i: go to edit box, focus input if only one, or with hint if multiple. I: go to edit box with vim editor)
(j: down)
(k: up)
(l: right)
(L: regional Mode)
...
settings.llm = {
    gemini: {
        apiKey: 'AIzaSyBsecKBjmHAtInVWF6ycAZBajerBxewA-k',
    },
    custom: {
