...
export const changeLog: ChangeLogItem[] = [
  ...
  { kind: ChangeLogKind.ADDED,   message: `lineSelection: multi cursor support, extend/shrink lines for last active cursor.`},
  ...
  { kind: ChangeLogKind.ADDED,   message: `metaJump: foreground decorator color for one char decorator.`},
