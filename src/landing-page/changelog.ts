...
export const changeLog: ChangeLogItem[] = [
  ...
  { kind: ChangeLogKind.ADDED,   message: `lineSelection: multi cursors support, extend/shrink lines for last active cursor.`},
  { kind: ChangeLogKind.ADDED,   message: `inPairSelection:`},
  { kind: ChangeLogKind.CHANGED,   message: `lineSelection: Ctrl+l to select current line or extend/shrink selection by one line below. Ctrl+o to extend/shrink selection by one line above.`},
