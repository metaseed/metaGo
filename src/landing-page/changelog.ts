...
export const changeLog: ChangeLogItem[] = [
  ...
  { kind: ChangeLogKind.ADDED,   message: `metaJump: forground decorator color for one char decorator, blue and yellow background for one and two length decorator.`},
